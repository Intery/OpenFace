...
namespace Utilities
{
	...
	*/
	...
	public:
        ...
        void SetTags(const cv::Mat tag1, const cv::Mat tag2);
		...
		void AddAprilTags(const std::vector<cv::Point2f>& eye_landmarks, const std::vector<cv::Point3f>& eye_landmarks3d, double confidence);
